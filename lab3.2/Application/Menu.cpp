...
int Menu::d_constructors() {
	...
	Polynomial_2* new_p = nullptr;
	try {
		switch (opt) {
			case 1: { // Default
				new_p = new Polynomial_2();
			...
			case 3: { // Polynomial
				...
				new_p = new Polynomial_2(deg, factors);
